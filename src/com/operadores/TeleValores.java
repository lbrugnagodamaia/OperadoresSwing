 ...
 * @author Pichau
 */
public class TeleValores extends javax.swing.JFrame {

    /**
     * Creates new form TeleValores
     */
    public TeleValores() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TeleValores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TeleValores().setVisible(true);
            }
        });
    }
